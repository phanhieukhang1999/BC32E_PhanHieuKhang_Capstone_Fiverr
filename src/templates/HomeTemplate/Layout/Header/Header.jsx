...
export default function Header(props) {
  ...
  return (
    ...
    <div className={`Header ${offset > 0 ? "scroll" : " "}`}>
      <header className="fiverr-header p-3 bg-transparent">
        <div className="container flex justify-between p-1 mx-auto">
          ...
          <ul className="fiverr-nav items-stretch mb-0  hidden space-x-3 lg:flex">
            ...
            <li className="flex">
              <NavLink rel="noopener noreferrer" to='/register' className="nav-link flex items-center py-2 px-4  rounded text-white hover:text-green-500"><span>Join</span></NavLink>
            </li>
          </ul>
