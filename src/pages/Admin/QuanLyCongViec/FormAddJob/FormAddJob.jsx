...
export default function FormAddJob({ setshowModal }) {
    ...
    return (
        <Form {...formItemLayout} onFinish={formik.handleSubmit} form={form} >
            ...
            >
                <Upload name="hinhAnh" action="/upload.do" listType="picture" value={formik.values.hinhAnh} onChange={formik.handleChange}>
            ...
            <Form.Item label='Giá tiền'>
                <Input name="giaTien" value={formik.values.giaTien} onChange={formik.handleChange} />
            </Form.Item>
